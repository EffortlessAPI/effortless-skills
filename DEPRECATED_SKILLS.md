...
| effortless-leopold-loop | effortless-loop | 2026-07-27 | 2026-09-27 | Renamed to `effortless-loop` in commit 085300b; this entry was missing so the old install never got cleaned up automatically. Same content, "the loop" is now the primary name with "Leopold loop" kept as an alias in the description. |
